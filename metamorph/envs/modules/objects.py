...
from metamorph.utils import placement as plu
    ...
    def add_obstacles(self, env):
        ...
        for idx in range(cfg.OBJECT.NUM_OBSTACLES):
            ...
            if cfg.OBJECT.TYPE == "box":
                ...
                # interpret bl as radius and bw as height
                obstacle_dims = [bl, bl, 2]
            pos = self.place_object(
            ...
            obstacle = xu.body_elem(name, pos)
            # Add obstacle geom
            if cfg.OBJECT.TYPE == "box":
                obstacle_type = "box"
                obstacle_size = xu.arr2str(obstacle_dims)
            elif cfg.OBJECT.TYPE == "cylinder":
                obstacle_type = "cylinder"
                obstacle_size = xu.arr2str([bl, 2])
